 ...
 * > <script language="javascript" type="text/javascript" src="jquery-1.4.4.min.html"></script>
 * > <script language="javascript" type="text/javascript" src="jquery.jqplot.min.html"></script>
 * > <link rel="stylesheet" type="text/css" href="jquery.jqplot.html" />
 * 
...
(function($) {
    ...
    Series.prototype.draw = function(sctx, opts, plot) {
        ...
        sctx = opts = plot = j = data = gridData.html = null;
    };
    ...
    function jqPlot() {
        ...
        this.init = function(target, data, options) {
            ...
            if (options.dataRenderer && jQuery.isFunction(options.dataRenderer)) {
                ...
                data = this-3.html this, this.dataRendererOptions);
            }
        ...
        for ( ; i < length; i++ ){
            ...
            if ( (options = arguments[ i ]) != null ) {
                ...
                for ( var name in options ) {
                    var src = target%5b.html name ], copy = options[ name ];
